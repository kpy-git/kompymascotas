...
{block name='step_content'}
    ...
    <div class="payment-options__list my-5 py-2 px-4 border b-1 rounded {if $is_free} d-block d-sm-none{/if}">
                ...
                <div id="{$option.id}-container" class="payment-option">
                    ...
                    <div class="payment-option__form-check form-check">
                        ...
                        <label class="payment-option__label form-check-label" for="{$option.id}">
                            {if $option.logo}
                                <img class="img-fluid mx-3" src="{$option.logo}" loading="lazy">
                            {/if}
