        ...
        >
            ...
            {elseif $customer.addresses|count> 0}
                ...
                {if $use_same_address && !$cart.is_virtual}
                    ...
                    <div class="kpy-form-group" style="cursor: pointer">
                        <a data-link-action="different-invoice-address" href="{$use_different_address_url}" class="form-check">
                            <input type="checkbox" class="form-check-input" id="same-directions" checked>
                            <label class="form-check-label kpy-form-check-label" for="same-directions">{l s='My billing address and sipping address are the same' d='Shop.Theme.Checkout'}</label>
                        </a>
                    </div>
                {/if}
            {/if}
