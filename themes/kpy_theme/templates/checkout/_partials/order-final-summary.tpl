...
<section id="order-summary-content" class="order__summary">
  ...
  <div class="order__summary__addresses mb-4">
          ...
          <div class="card-body">
            <div class="address__content col-10">
              ...
              <address class="address__content">
                  {$customer.addresses[$cart.id_address_delivery].firstname} {$customer.addresses[$cart.id_address_delivery].lastname}<br />
                  {$customer.addresses[$cart.id_address_delivery].dni}<br />
                  {$customer.addresses[$cart.id_address_delivery].address1} {if $customer.addresses[$cart.id_address_delivery].address2}{$customer.addresses[$cart.id_address_delivery].address2}{/if}<br />
                  {$customer.addresses[$cart.id_address_delivery].postcode} {$customer.addresses[$cart.id_address_delivery].city}<br/>
                  {$customer.addresses[$cart.id_address_delivery].phone}
              </address>
        ...
        <div class="address card">
          <div class="card-body">
            <div class="address__content col-10">
              ...
              <address class="address__content">
                  {$customer.addresses[$cart.id_address_invoice].firstname} {$customer.addresses[$cart.id_address_invoice].lastname}<br />
                  {$customer.addresses[$cart.id_address_invoice].dni}<br />
                  {$customer.addresses[$cart.id_address_invoice].address1} {if $customer.addresses[$cart.id_address_invoice].address2}{$customer.addresses[$cart.id_address_invoice].address2}{/if}<br />
                  {$customer.addresses[$cart.id_address_invoice].postcode} {$customer.addresses[$cart.id_address_invoice].city}<br/>
                  {$customer.addresses[$cart.id_address_invoice].phone}
              </address>
    ...
    {if !$cart.is_virtual}
      ...
      <div class="border b-1 rounded p-5 p-xs-3 mb-4">
        <div class="delivery-options__item js-delivery-option">
          <div class="row">
            <div class="delivery-option__left col-6 mb-2 mb-sm-0 order-0">
            ...
            <span class="delivery-option__right fw-bold fs-5 col-6 order-1 order-sm-2 d-flex align-items-center justify-content-end">
