        ...
        {block name='login_form_footer'}
            ...
            <div class="buttons-wrapper buttons-wrapper--split buttons-wrapper--invert-mobile">
                ...
                {block name='form_buttons'}
                    <button id="submit-login" class="btn btn-primary w-100" data-link-action="sign-in" type="submit" data-ps-action="form-validation-submit">
                        {l s='Sign in' d='Shop.Theme.Actions'}
                    </button>
                {/block}

                <a class="btn btn-basic mt-4 text-center w-100" href="{$urls.pages.password}" rel="nofollow">
