...
<body id="{$page.page_name}" class="{$page.body_classes|classnames} {if $modules.kpyfrontcontrollervariables.is_mobile}is_mobile{/if}">
...
<header id="header" class="header js-sticky-header {if $modules.kpyfrontcontrollervariables.is_mobile}is_mobile{/if}">
      {block name='header'}
