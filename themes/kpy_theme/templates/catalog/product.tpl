...
{block name='content'}
  ...
  <div class="row g-4 g-xl-5 product js-product-container align-items-start">
  <div class="product__left col-xl-4">
  ...
  <div class="product__actions js-product-actions col">
  ...
  <div class="col-xs-12">
    ...
    <div class="product__infos accordion accordion-flush" id="product-infos-accordion">
        ...
        {block name='product_description'}
          {widget name='kpyproductdescription' hook='description' id_product=$product.id}
            {*
