            ...
            {block name='product_miniature_bottom'}
                <div class="{$componentName}__bottom">
                    <div class="{$componentName}__infos">
                        ...
                        {if $product.show_price}
                            <div class="{$componentName}__prices">
                                {block name='product_price'}
                                    ...
                                    <div class="{$componentName}__price {if $product.kpy_special_price} kpy-special-price-listing{/if}" aria-label="{l s='Price' d='Shop.Theme.Catalog'}">
                        ...
                        {block name='product_variants_detail'}
                            {hook h='displayProductListVariantsDetails' product=$product}
                        {/block}
                    </div>

                    <div class="{$componentName}__actions">
                        {if !$modules.kpyfrontcontrollervariables.is_mobile}
                            <div class="text-center w-100 mt-2 product-list-view-options">
                                <a href="{$product.url}" class="btn btn-outline-primary">
                                    {l s='View options' d='Shop.Theme.Actions'}
                                </a>
                            </div>
                        {/if}
