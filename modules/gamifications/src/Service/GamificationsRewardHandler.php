...
class GamificationsRewardHandler
{
    ...
    public function handleCustomerReward(
        ...
        switch ((int) $reward->reward_type) {
            ...
            case GamificationsReward::REWARD_TYPE_GIFT:
                $voucher = $this->createVoucher($reward, $gamificationsCustomer);
        ...
        if ($results['success']) {
            ...
            GamificationsActivityHistory::log($reward, $gamificationsCustomer->id_customer, $activityType, $points, $voucher);
        }
    ...
    {
        /**
         06/07/2022 - a partir de ahora los cupones no se crean con la combianción por defecto del producto que se
         regala, ahora se guarda también el id de la combinación al crear el reward
        ...
        */
        ...
        $voucher->gift_product = $reward->id_product;
        $voucher->gift_product_attribute = $reward->id_product_attribute;
    }
}
