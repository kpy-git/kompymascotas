    ...
    public function initPageHeaderToolbar()
    {
        if (empty($this->display)) {
            $this->page_header_toolbar_btn['new_reward'] = [
                ...
                'desc' => $this->trans('Add new reward', [], 'Modules.Gamifications.Admin'),
        ...
        $this->fields_form = [
            ...
            'input' => [
                ...
                [
                    ...
                    'name' => 'points',
                    'type' => 'text',
                    'hint' => $this->trans('Number of points that customer will get', [], 'Modules.Gamifications.Admin'),
                ...
                [
                    ...
                    'type' => 'text',
                    'hint' =>
                        $this->trans('E.g. if entered 100 points and radius 30,', [], 'Modules.Gamifications.Admin').' '.
                        $this->trans('then range is 70 - 130 points (+-30 points)', [], 'Modules.Gamifications.Admin'),
                    'class' => 'fixed-width-sm',
                    'suffix' => $this->trans('points radius', [], 'Modules.Gamifications.Admin'),
                ],
                /*[
                    ...
                    'name' => 'product_name',
                    'type' => 'text',
                    'hint' => $this->trans('Enter product name or full reference and available products will show up', [], 'Modules.Gamifications.Admin'),
                ...
                [
                    ...
                    'name' => 'sku',
                    'type' => 'text',
                    'hint' => 'sku completo (id_product-id_combinación) del producto que se va a regalar',
                    'class' => 'fixed-width-xxl'
                ],
                [
                    'label' => '',
                    ...
                    'options' => [
                        ...
                        'query' => [
                            ...
                            [
                                ...
                                'name' => sprintf($this->trans('Amount (%s)', [], 'Modules.Gamifications.Admin'), $defaultCurrency->iso_code),
                            ],
                        ],
                    ],
                ],
                [
                    ...
                    'type' => 'text',
                    'name' => 'discount_value',
                    'hint' => $this->trans('Percent (%) or amount', [], 'Modules.Gamifications.Admin'),
                    'class' => 'fixed-width-sm',
                ],
                [
                    ...
                    'hitn' => $this->trans('How many days discount will be valid after earning it', [], 'Modules.Gamifications.Admin'),
                ...
                [
                    ...
                    'hint' => $this->trans('Minimum cart amount that discount or free shipping apply', [], 'Modules.Gamifications.Admin'),
                    'class' => 'fixed-width-sm',
    ...
    protected function loadObject($opt = false)
    {
        ...
        if (Validate::isLoadedObject($this->object)) {
            if ($this->object->id_product) {
                ...
                $this->object->sku = sprintf('%d-%d', $this->object->id_product, $this->object->id_product_attribute);
            }
        }
