        ...
        $this->fields_form = [
            ...
            'input' => [
                [
                    ...
                    'hint' => sprintf(
                        $this->trans('Give X points for every spent %s. Points are calculated by default currency.', [], 'Modules.Gamifications.Admin'),
                        $currency->iso_code
                    ),
                    'suffix' => sprintf($this->trans('points = for every spent %s', [], 'Modules.Gamifications.Admin'), $currency->iso_code),
                ...
                [
                    ...
                    'hint' =>
                        $this->trans('Give points after order state is one of selected.', [], 'Modules.Gamifications.Admin').' '.
                        $this->trans('If no orders states are selected then points will be given after placing an order.', [], 'Modules.Gamifications.Admin'),
                ...
                [
                    ...
                    'hint' => $this->trans('Enabled to include shipping price when calculating points', [], 'Modules.Gamifications.Admin'),
                    'is_bool' => true,
                    'values' => [
                        [
