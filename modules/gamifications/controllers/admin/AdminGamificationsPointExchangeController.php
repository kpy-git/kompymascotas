    ...
    public function initPageHeaderToolbar()
    {
        if (empty($this->display)) {
            $this->page_header_toolbar_btn['new_reward'] = [
                ...
                'desc' => $this->trans('Add new Points Exchange', [], 'Modules.Gamifications.Admin'),
        ...
        $this->fields_form = [
            ...
            'input' => [
                [
                    ...
                    'type' => 'text',
                    'name' => 'points',
                    'hint' => $this->trans('Points needed to exchange it into reward', [], 'Modules.Gamifications.Admin'),
                ...
                [
                    ...
                    'type' => 'select',
                    'name' => 'id_reward',
                    'hint' => $this->trans('List of available rewards. NOTE: You cannot exchange points into points.', [], 'Modules.Gamifications.Admin'),
                    'required' => true,
                    'options' => [
                ...
                [
                    ...
                    'name' => 'active',
                    'hint' => $this->trans('If disabled then customers will not be able to use this exchange', [], 'Modules.Gamifications.Admin'),
                ],
                [
                    ...
                    'hint' => $this->trans('Which customer groups can get this reward by exchanging points', [], 'Modules.Gamifications.Admin'),
                ],
            ],
            'submit' => [
