        ...
        $this->fields_form = [
            ...
            'input' => [
                ...
                [
                    ...
                    'hint' => $this->trans('Time when referrer customer gets reward for inviting new customer', [], 'Modules.Gamifications.Admin'),
                    'type' => 'radio',
                    'values' => [
                        [
                ...
                [
                    ...
                    'hint' => $this->trans('Reward referrer customer when new customer\'s order state is one of selected', [], 'Modules.Gamifications.Admin'),
                ...
                [
                    ...
                    'hint' => $this->trans('Enabled if you want to reward new customer', [], 'Modules.Gamifications.Admin'),
                    'type' => 'switch',
                    'values' => [
                        [
                            'id' => 'active_on',
