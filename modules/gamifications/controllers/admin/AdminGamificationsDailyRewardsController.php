    ...
    public function initPageHeaderToolbar()
    {
        if (empty($this->display)) {
            $this->page_header_toolbar_btn['new_daily_reward'] = [
                ...
                'desc' => $this->trans('Add new Daily Reward', [], 'Modules.Gamifications.Admin'),
        ...
        $this->fields_form = [
            ...
            'input' => [
                [
                    ...
                    'hint' => $this->trans('Choose reward that customer will have a chance to get.', [], 'Modules.Gamifications.Admin'),
                    'type' => 'select',
                    'name' => 'id_reward',
                    'required' => true,
                    'options' => [
                ...
                [
                    ...
                    'hint' => $this->trans('The chance of getting this reward.', [], 'Modules.Gamifications.Admin').' '.
                        $this->trans('The higher the boost the bigger chance of getting this reward.', [], 'Modules.Gamifications.Admin'),
                    'class' => 'fixed-width-xl',
                    'desc' =>
                        $this->trans('Recommended boost is between 1 (less chance to get) and 100 (more chance to get).', [], 'Modules.Gamifications.Admin'),
                ],
                [
                    ...
                    'values' => [
                        [
                            'id' => 'active_on',
                            'value' => 1,
                            'label' => $this->trans('Yes', [], 'Modules.Gamifications.Admin'),
                        ],
                        [
                            'id' => 'active_off',
                            'value' => 0,
                            'label' => $this->trans('No', [], 'Modules.Gamifications.Admin'),
                        ],
                    ],
                    'name' => 'active',
                    'hint' => $this->trans('If disabled then no one will be able to get this reward at Daily Rewards', [], 'Modules.Gamifications.Admin'),
                ],
                [
                    ...
                    'hint' => $this->trans('Which customer groups can get this Daily Reward', [], 'Modules.Gamifications.Admin'),
                ],
            ],
            'submit' => [
