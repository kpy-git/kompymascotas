...
if (! class_exists ( 'RESTOperationElement' )) {
	...
	class RESTOperationElement extends RESTGenericXml {
		...
		*/
		...
		/**
		 * @XML_ELEM=Ds_ProcessedPayMethod
		 */
		private $processedPayMethod;
		...
		*/
		...
		//processedPayMethod
		public function getProcessedPayMethod() {
			return $this->processedPayMethod;
		}
		public function setProcessedPayMethod($processedPayMethod) {
