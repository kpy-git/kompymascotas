...
{if $versionGTE16}
	...
	<p class="payment_module">
		<a id="aRedsysReference" style="padding-left: 15px" href="javascript:gotoRedsysReference();">	
			<img src="{$module_dir|escape:'htmlall'}img/cards-icon-visa-mc.png" alt="{l s='Conectar con el TPV' mod='redsys'}" height="48" />
			<span id="redsysRef_title" style="color: #333">{$payment_name} {if $show_brand==true} <img src="{$module_dir|escape:'htmlall'}views/templates/front/assets/brands/{$card_brand}.jpg"/> {/if}</span>
