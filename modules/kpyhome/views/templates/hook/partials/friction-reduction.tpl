<section class="friction-reduction">
  <div class="container">
    ...
    <div class="friction-grid">
      <div class="friction-item">
        ...
        <h3>{l s='Shipping and delivery' d='Modules.Kpyhome.Shop'}</h3>
        <p>
      ...
      <div class="friction-item">
        <div class="friction-icon">
          <img src="{$module_img}credit-card.svg" alt="payment card">
        </div>
        <h3>{l s='100% secure payment.' d='Modules.Kpyhome.Shop'}</h3>
        <p>{l s='We do not store your card details.' d='Modules.Kpyhome.Shop'}</p>
      </div>
      ...
      <div class="friction-item">
        ...
        <h3>{l s='Returns and refunds' d='Modules.Kpyhome.Shop'}</h3>
        <p>
      ...
      <div class="friction-item">
        ...
        <h3>{l s='Customer service' d='Modules.Kpyhome.Shop'}</h3>
        <p>
