  ...
  <div class="container-full">
    <div class="carousel-wrapper">
      ...
      <div class="carousel-hero-image">
        ...
        <a href="{$link}" class="hero-cta">{if isset($link_text)}{$link_text}{else}{l s='View all' d='Modules.Kpyhome.Shop'}{/if} <span><i class="material-icons">chevron_right</i></span></a>
      </div>
