...
namespace PrestaShop\Module\KpyProductAvailabilityMessages\Install;

use Db;
use Module;
use PrestaShop\Module\KpyProductAvailabilityMessages\Config\Tables;
...
class Installer
{
    ...
    private function executeSqlFromFile(string $filepath): bool
    {
        ...
        $sqlLoader->setMetaData([
            ...
            'TABLE_PENDING_ORDERS' => Tables::TABLE_PENDING_ORDERS,
            'TABLE_SUPPLIERS' => Tables::TABLE_SUPPLIERS,
            'TABLE_SUPPLIER_MANUFACTURER' => Tables::TABLE_SUPPLIER_MANUFACTURER,
            'TABLE_PRODUCT_ARRIVAL_DATE' => Tables::TABLE_PRODUCT_ARRIVAL_DATE,
            'TABLE_SUPPLIER_PRODUCT' => Tables::TABLE_SUPPLIER_PRODUCT,
        ]);
